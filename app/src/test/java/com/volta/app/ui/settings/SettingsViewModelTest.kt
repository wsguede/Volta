...
private class FakeAppVersionDataSource(override val versionName: String = "9.9.9") :
...
class SettingsViewModelTest {
    ...
    fun `initial uiState reflects the repository's persisted resolution`() = runTest {
        ...
        val viewModel = SettingsViewModel(repository, FakeAppVersionDataSource())
    ...
    fun `uiState formats the app version from the version provider`() = runTest {
        ...
        val viewModel = SettingsViewModel(
            repository,
            FakeAppVersionDataSource(versionName = "9.9.9")
        )
